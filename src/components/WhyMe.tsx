    ...
    <section id="why-me" className="bg-white section-mobile">
      <div className="max-w-[1120px] mx-auto px-5 md:px-8">
        <div ref={section.ref} className={`max-w-2xl mb-8 md:mb-14 reveal-hidden ${section.isVisible ? 'reveal-visible' : ''}`}>
          <p className="text-[11px] md:text-[13px] font-semibold text-[#995800] uppercase tracking-widest mb-2 md:mb-3">Why Me</p>
        ...
        <div className="max-w-3xl">
          ...
          <div className="space-y-2.5 md:space-y-3 mb-8 md:mb-10">
            {DIFF_POINTS.map((p, i) => (
              ...
              >
                <CheckCircle2 className={`w-[18px] h-[18px] md:w-5 md:h-5 flex-shrink-0 mt-0.5 ${p.highlight ? 'text-[#995800]' : 'text-[#995800]/40'}`} />
...
export function Approach() {
  ...
  return (
    <section className="bg-surface section-mobile">
      <div className="max-w-[1120px] mx-auto px-5 md:px-8">
        <div ref={section.ref} className={`max-w-2xl mb-8 md:mb-14 reveal-hidden ${section.isVisible ? 'reveal-visible' : ''}`}>
          <p className="text-[11px] md:text-[13px] font-semibold text-[#995800] uppercase tracking-widest mb-2 md:mb-3">Method</p>
