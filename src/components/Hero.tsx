          ...
          <div className="flex flex-col items-center text-center lg:flex-row lg:text-left lg:items-center gap-8 lg:gap-16">
            ...
            <div className={`flex-1 max-w-2xl transition-all duration-700 delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              ...
              <h1 className="text-[26px] sm:text-[34px] md:text-[44px] lg:text-[48px] font-extrabold text-white leading-[1.08] tracking-[-0.03em] mb-4 md:mb-5">
                Most dashboards are wrong.
                <br />
                <span className="text-gradient">Not because of the tools.</span>
              </h1>

              {/* Subheadline */}
              <p className="text-[14px] md:text-[17px] text-white/50 leading-relaxed mb-4 max-w-xl mx-auto lg:mx-0">
                Because of the data behind them. I build reliable data systems <span className="text-white/70 font-medium">from raw data to business-ready metrics</span> your team can actually trust.
              </p>
              ...
              <div className="flex items-center justify-center lg:justify-start gap-1.5 sm:gap-2 text-[11px] sm:text-[12px] md:text-[13px] mb-5 md:mb-7">
                <span className="glass-pill px-2.5 py-1 rounded-full text-white/40">Clean data</span>
                <span className="text-accent/30 text-[16px]">&rarr;</span>
                <span className="glass-pill px-2.5 py-1 rounded-full text-white/40">Tested transformations</span>
                <span className="text-accent/30 text-[16px]">&rarr;</span>
                <span className="px-2.5 py-1 rounded-full bg-accent/[0.08] border border-accent/[0.12] text-accent/70">Trusted KPIs</span>
              </div>

              {/* Proof line */}
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-x-4 gap-y-1.5 text-[12px] md:text-[13px] text-white/30 mb-6 md:mb-8">
                <span className="flex items-center gap-1.5">
                  <span className="w-1 h-1 rounded-full bg-accent/50" />
                  6K LinkedIn community
                </span>
                <span className="flex items-center gap-1.5">
                  <span className="w-1 h-1 rounded-full bg-accent/50" />
              ...
              {/* Microcopy */}
              <p className="mt-3.5 flex items-center justify-center lg:justify-start gap-1.5 text-[11px] text-white/20">
                <Clock className="w-3 h-3" />
                Free &middot; No commitment &middot; Replies within 24h
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white">
        <div className="max-w-[1120px] mx-auto px-5 md:px-8 py-10 md:py-20">
          <div className="grid grid-cols-2 gap-6 md:gap-10">
            <AnimatedCounter target={50} suffix="+" label="Stakeholders served" desc="Dashboards trusted by real teams at SETRAG" />
            <AnimatedCounter target={70} suffix="%" label="Reporting time cut" desc="Automated KPI tracking replacing manual work" />
            <AnimatedCounter target={7} suffix="" label="Certifications" desc="dbt, SQL, Airflow, AWS, dlt & more" />
            <div className="group cursor-default">
              ...
              <p className="text-[12px] md:text-[13px] text-gray-400 mt-0.5 leading-snug">Data professionals following my work</p>
            </div>
          </div>
        </div>
      </section>
